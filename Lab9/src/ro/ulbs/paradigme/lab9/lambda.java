...
public class lambda {
    public static void main(String[] args) {
        ...
        String prop = "Program scris cu java 8 si expresii lambda:";
        ...
        System.out.println("Lungimea cuvintelor este >= 5: " + longWords);
        List<String> sortedWords = longWords.stream().sorted().collect(Collectors.toList());
        System.out.println("Cuvintele ordonate astfel: " + sortedWords);
